...
export default function Acc(props) {
  ...
  //   })
  //  const[ChangeMode,nextChangeMode] = useState("Dark Mode")
  ...
  <div className="accordion-item">
    ...
    <div id="collapseTwo" className="accordion-collapse collapse" style={{backgroundColor:props.mode==='dark'?'black':'white',color:props.mode=='dark'?'white':'black'}} data-bs-parent="#accordionExample">
      <div className="accordion-body">
  ...
  <div className="accordion-item">
    ...
    <div id="collapseThree" style={{backgroundColor:props.mode==='dark'?'black':'white',color:props.mode=='dark'?'white':'black'}} className="accordion-collapse collapse" data-bs-parent="#accordionExample">
      <div className="accordion-body">
...
{/* <button  type="button" className="btn btn-primary">ChangeMode</button> */}
    </>
  )
}
